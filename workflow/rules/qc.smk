...
rule fastqc_raw:
    ...
    threads: 
        config['resources']['fastqc']['threads']
...
rule multiqc:
    ...
    params:
        ...
        output_dir = os.path.join(RESULTS_DIR, "07_multiqc"), #f"{RESULTS_DIR}/07_multiqc"
        bind_paths = lambda w: _apptainer_binds([RESULTS_DIR])
    ...
    shell:
        ...
        apptainer exec {params.bind_paths} {params.multiqc} \
             multiqc {RESULTS_DIR} -o {output.multiqc_report}
        """