...
# read_sample_sheet : Read the sample sheet
# validate_sample_sheet: Validate it for correctness
# check_fastq_path_exists: Check if the file paths are valid
...
def check_fastq_paths_exist(df: pd.DataFrame) -> None:
    for idx, row in df.iterrows():
        # If sample column exists, use it; otherwise use index
        sample = row["sample"] if "sample" in df.columns else idx
