...
from config import BOUNDARY_STYLE, DEFAULT_COLOR, HEATMAP_GRADIENT, ZONE_COLORS
...
def add_legend(map_obj, df):
    ...
    for zone in unique_zones:
        zones.append({"name": zone, "color": get_zone_color(zone)})

    legend_html = legend_template.render(zones=zones, total_samples=len(df))
